        ...
        <v-row :column="$vuetify.breakpoint.mdAndDown">
          <v-col cols="12" lg="6">
            ...
            <v-card class="fill-height" rounded="lg">
              <img alt="" src="/forDemo/test1.png" width="350em"  style="display:block; margin:auto; align:center"
/>
            </v-card>
          </v-col>
          ...
          <v-col cols="12" lg="6">
            ...
            <v-card class="mr-3 fill-height" rounded="lg">
              <img alt="" src="/forDemo/nnn.png" width="350em" style="display:block; margin:auto; align:center"
/>
            </v-card>
          </v-col>
