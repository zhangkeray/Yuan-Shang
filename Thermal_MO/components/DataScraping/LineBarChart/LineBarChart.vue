<template>
  <div ref="donutChart1" style="height: 670px; width: 1250px"></div>
</template>
    ...
    drawBar() {
      ...
      option = {
        ...
        legend: {
          ...
          itemGap: 20,
          data: ['2022', '2021', '2020', '2019', '2022-2021'],
          inactiveColor: '#ccc',
        },
        xAxis: [
          {
        ...
        series: [

          {
            name: '2022',
            type: 'bar',
            data: [56, 42, 57, 45, 54, 32, 49, 34, 48, 46, 55, 50],
            // barWidth: '50%',
          },
          {
            name: '2022',
            type: 'bar',
            data: [46, 44, 39, 48, 40, 60, 55, 59, 37, 49, 52, 53],
            // barWidth: '50%',
          },
          {
            name: '2022',
          ...
          },
          {
            ...
            type: 'line',
            yAxisIndex: 0, // 這裡要設定哪個y軸，預設是最左邊的是0，然後1，2順序來。
            data: [72, 95, 64, 83, 87, 80, 91, 79, 85, 65, 96, 63],
            symbolSize: 10,
            itemStyle: {
              normal: {
                color: '#CD5C5C',
          ...
          },
          {
            ...
            type: 'line',
            yAxisIndex: 0, // 這裡要設定哪個y軸，預設是最左邊的是0，然後1，2順序來。
            data: [70, 68, 79, 83, 62, 64, 73, 87, 92, 60, 70, 91],
            symbolSize: 10,
            itemStyle: {
              normal: {
                color: '#CD5C5C',
