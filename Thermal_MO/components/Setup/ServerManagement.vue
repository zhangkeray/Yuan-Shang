                    ...
                    <v-card-text>
                      <v-row>
                        <v-col cols="12" md="12" class="ma-0 pb-0">
                          ...
                          >
                            <v-row>
                              <v-col cols="6" class="d-flex pb-0 px-0">
                              ...
                              <v-col cols="6" class="d-flex pb-0 px-0">
                                ...
                                <div cols="12" class="d-flex pb-0">
                                  <v-text-field
                                    outlined
                                    hide-details
                                    v-model="server_main_position"
                                    placeholder="server-00"
                                    dense
                                    color="#4f5e62"
                              ...
                              <v-col cols="6" class="d-flex py-0 px-0">
                                ...
                                <div cols="12" class="d-flex pb-0">
                                  <v-text-field
                                    outlined
                                    hide-details
                                    placeholder="svr-s1-14"
                                    dense
                                    color="#4f5e62"
                                    style="color: #4f5e62; margin-right: 24px"
                                    class="tiny_input"
                                  ></v-text-field>
                                </div>
                              </v-col>
                              ...
                              <v-col cols="6" class="d-flex pt-0 px-0 pb-2">
                                ...
                                <div class="d-flex">
                                  ...
                                  ></v-select>
                                  <v-select
                                    class="most_tiny_input_select mr-6"
                                    dense
                                    outlined
                                    ref=""
                                    hide-details
                              ...
                              <v-col cols="6" class="d-flex py-0 px-0">
                                ...
                                <div cols="12" class="d-flex pb-0">
                                  <v-text-field
                                    ...
                                    dense
                                    color=""
                                    style="color: green; margin-right: 25px"
                                    class="tiny_input"
                                    disabled
                                    background-color="rgba(0, 0, 0, 0.05)"
                                  ></v-text-field>
                    ...
                    <v-card-text>
                      <v-row>
                        <v-col cols="12" md="4" class="ma-0">
                          <v-card class="my-0 ma-0 pa-0" flat>
                            <v-row>
                              <v-card
                                class="card ml-3 pr-2 px-0 mb-2 mt-3"
                                flat
                                outlined
                              >
                                <v-col cols="12" class="d-flex pb-0">
                                  <h7 class="mb-1 pb-0 pl-3 font">名稱</h7>
                                  <!-- <v-spacer class="font mb-1" /> -->
                                  <div cols="12" class="d-flex pb-0 pl-15">
                                    <v-text-field
                                      outlined
                                      hide-details
                                      placeholder="svr-s1-14"
                                ...
                                <v-col cols="12" class="d-flex py-0">
                                  <h7 class="mb-3 pb-0 pl-3 font">位置</h7>
                                  <!-- <v-spacer class="font mb-1" /> -->
                              ...
                              <v-col cols="12" class="d-flex py-0">
                                <h7 class="mb-1 pl-6 pb-0 font_bg_color"
                                  >系統編號</h7
                                >
                                <v-spacer class="font_bg_color mb-1 mx-0" />

                                <v-icon
                                  large
                                  class="font_bg_color mb-1 pb-0 serv_icon"
                                  v-if="editedItem.server_status === '1'"
                                  :color="getGreenColor()"
                                  ...
                                  <v-expansion-panel class="pa-0 pl-3 mb-1">
                                    ...
                                    >
                                      <v-col cols="12" class="d-flex py-0 pt-1">
                                        <h7 class="pl-3 font_bg_color"
                                          >硬碟使用量</h7
                                        >
                                        <v-spacer class="font_bg_color mb-1" />

                                        <h7
                                          class="mb-1 pb-0 font_bg_color"
                                          v-if="
                                    ...
                                    >
                                      <v-row>
                                        ...
                                        <v-col
                                          cols="6"
                                          class="pt-13 pb-2 pl-0 ml-0"
                                        >
                                          <v-row>
                                            <v-col cols="7" class="d-flex py-0">
                                              <h7
                                                class="my-0 py-0 font_bg_color"
                                                >剩餘空間</h7
                                              >
                                            </v-col>
                                            <v-col cols="5" class="d-flex py-0">
                                              <!-- <v-spacer /> -->
                                              <h7
                                                class="my-0 py-0 font_bg_color"
                                                >{{
